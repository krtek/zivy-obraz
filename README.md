...
node src/dashboard-sync.mjs --bakalari-base-url="$BAKALARI_BASE_URL" --bakalari-username="$BAKALARI_USERNAME" --bakalari-password="$BAKALARI_PASSWORD"--output="dashboard/dashboard.png"
```
